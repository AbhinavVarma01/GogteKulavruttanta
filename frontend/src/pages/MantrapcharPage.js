...
const MantrapcharPage = () => {
  ...
  const handleMantraClick = (mantraNumber) => {
    if (mantraNumber === 1) {
      setShowVideo1(true);
    } else {
      setShowVideo2(true);
            ...
            >
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-4 font-sans" style={{ fontFamily: 'Montserrat, Open Sans, Arial, sans-serif' }}>
                  Click to view Mantrapchar options
                </p>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8">
              ...
              <h2 className="text-3xl font-bold text-amber-800 font-sans" style={{ fontFamily: 'Montserrat, Open Sans, Arial, sans-serif' }}>
                {selectedDeity === 'vyadeshwar' ? 'व्यादेश्वर मंत्रपचार' : 'योगेश्वरी देवी मंत्रपचार'}
              </h2>
            </div>
          ...
          <div className="relative w-full max-w-4xl">
            ...
            <div className="relative w-full" style={{ paddingBottom: '56.25%' }}>
              <iframe
                ...
                src={`https://www.youtube.com/embed/BXz3yOBiXGY?autoplay=1`}
...
export default MantrapcharPage; 