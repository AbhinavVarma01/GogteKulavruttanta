...
const Footer = () => (
  <footer className="w-full bg-orange-100 border-t border-orange-300 py-4 mt-8 text-center text-gray-700 text-sm font-sans" style={{ fontFamily: 'Montserrat, Open Sans, Arial, sans-serif' }}>
    <div className="flex flex-col md:flex-row items-center justify-center gap-2 md:gap-6">
      <span>© 2025 GogteKulavruttanta. All rights reserved.</span>
      <span className="hidden md:inline">|</span>
      <span>Contact: <a href="mailto:info@gogtekul.com" className="text-orange-700 underline hover:text-orange-900 font-medium">info@gogtekul.com</a></span>
      <span className="hidden md:inline">|</span>
